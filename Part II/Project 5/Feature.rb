...
# Assignment: Come up with a different action the player could take
#             and add that feature to the game.
# Started Wednesday May 24th 2017
# Completed Wednesday May 24th 2017
# 
...
while damage_points > 0 and not escaped do
    ...
    if player_action == "m"
      ...
      if distract_monster?
        monster = false
        puts "You distracted the scary monster!"
      else
        puts "The monster didn't fall for it."
      end
    else
